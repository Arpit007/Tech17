...
public class EventModel extends BaseEventModel implements Serializable
{
	...
	public interface EventStatusListener {
		void EventStatusChanged(com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus status);
	}
	...
	private com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus status= com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus.None;
	...
	public com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus getEventStatus(){return  status;}
	...
	public void callStatusListener(com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus status) {
		this.status=status;
		if(listener!=null)
			listener.EventStatusChanged(status);
	}
	...
	public void setStatus(com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus status){this.status=status;}
	...
	public void setRoundLive() {
		...
		if (status == com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus.Over)
		{
			CurrentRound++;
		}
		status = com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus.Live;
	}
	public void setRoundOver()	{
		status = com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus.Over;
	}
	public void setNextRound() {
		if (status == com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus.Over && !isFinalRound())
		{
			CurrentRound++;
			status = com.nitkkr.gawds.techspardha17.Model.EventModel.EventStatus.Upcoming;
		}
	}
}
